...
orderschema = StructType([
    ...
    StructField("Customer3", StringType(), True),
...
silver_path="abfss://SGSCo_Fabric_Development@onelake.dfs.fabric.microsoft.com/SILVER.Lakehouse/Tables/CP/employeelaborhours_customer3_month"
...
if in_mode == "FULL":
    ...
    df.write.format("delta").mode("overwrite").saveAsTable("CP.EmployeeLaborHours_Customer3_Month")
    bronze_Path ="abfss://SGSCo_Fabric_Development@onelake.dfs.fabric.microsoft.com/BRONZE.Lakehouse/Tables/CP/EmployeeLaborHours_Customer3_Month"
...
# Merge data from Bronze Full to Silver with only the specified columns
    ...
    "Customer3": col("source.Customer3"),
    ...
    df.write.format("delta").mode("append").saveAsTable("CP.EmployeeLaborHours_Customer3_Month")
    
    source_path = "abfss://SGSCo_Fabric_Development@onelake.dfs.fabric.microsoft.com/BRONZE.Lakehouse/Tables/CP/EmployeeLaborHours_Customer3_Month"
